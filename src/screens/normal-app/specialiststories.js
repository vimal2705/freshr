...
import { StoriesHoc } from "./stories-hoc";
...
const ProfilePicture = styled.Image`
  ...
  overflow: hidden;
`;
const SpecialistStories = ({route, ...restProps }) => {
  ...
  useEffect(() => {
    ...
    setGallery(route.params.stories);
    console.log("ssss",gallery);
  ...
  return (
    <StoriesHoc showBackButton={true}>
