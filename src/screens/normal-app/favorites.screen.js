      ...
      >
...

        {
          favfacilities.map((item, i) => {
            ...
            return (
              <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginVertical: 5 }}>
                <TouchableOpacity style={{ flexDirection: 'row', gap: 20, alignItems: 'center' }} onPress={() => sendFacilityyy(item._id)}>
